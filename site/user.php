    ...
    <div class="MENU border-[1px] border-gray-200 grid grid-cols-3">
        <form class="right bg-[#F6F5F3] col-span-2"  method="post" action="index.php?act=signup">
            <div class="mx-32 my-20">
                ...
                <hr class="mt-5 mb-10">
                <h3 class="font-bold text-2xl ">LOGIN INFORMATION</h3>
                <div class="bg-[#FFFFFF] my-10 rounded">
                    ...
                    <div class="mx-10 py-10 space-y-4">
                        ...
                        <input type="text" placeholder="Peter Parker ?" name="fullname"
                            class="py-4 px-4 w-full border-2 rounded border-[#CFCCC8]" required>
                    </div>
                    <div class="mx-10 py-10 space-y-4">
                    ...
                    <div class="mx-10 py-10 space-y-4 space-x-4">
                        ...
                        <input type="radio" name="role" value="1"><label for="">Guest</label>
                        <input type="radio" name="role" value="1"><label for="">Admin</label>
                    </div>
                </div>
                <button class="font-semibold text-xl px-6 py-2 bg-black text-[#FFFFFF]" type="submit" name="confirm">Confirm</button>
            </div>
        </form>
        <div class="left col-span-1">
            ...
            <div class="bg-[#F6F5F3] mx-10 my-10 py-10 px-6 space-y-4">
                <h3 class="font-bold text-xl ">BY CREATING A MY RL ACCOUNT, YOU WILL BE ABLE TO:</h3>
                <div class="flex space-x-4 items-center">
                    ...
                    <span>Follow your online orders, access your purchase history and e-receipts</span>
                </div>
                <hr>
                <div class="flex space-x-4 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="flex space-x-4 items-center">
                    ...
                    <span>Receive Royal Center digital communication</span>
                </div>
                <hr>
                <div class="flex space-x-4 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <span>Create your personal Wishlist</span>
                </div>
            </div>
        </div>
    </div>
