...
<div class="dmnb my-10 max-w-[1080px] mx-auto grid grid-cols-2  items-center">
    <div class=""><button class="border-2 border-black py-1 px-5 font-black flex items-center">Category<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-activity mx-2" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M6 2a.5.5 0 0 1 .47.33L10 12.036l1.53-4.208A.5.5 0 0 1 12 7.5h3.5a.5.5 0 0 1 0 1h-3.15l-1.88 5.17a.5.5 0 0 1-.94 0L6 3.964 4.47 8.171A.5.5 0 0 1 4 8.5H.5a.5.5 0 0 1 0-1h3.15l1.88-5.17A.5.5 0 0 1 6 2Z" />
            </svg></button>
    </div>
    <div class="text-right ">
        <span><a href="">Previos</a></span>
        <span>|</span>
...
<div class="dmnb my-5 max-w-[1080px] mx-auto grid grid-cols-3  items-center">
...
<div class="max-w-[1280px] mx-auto flex justify-between items-center">
    <div class="flex rounded-2xl font-black bg-[#EDF7FA] py-4 px-1">
        ...
        <span class=" mx-4 text-[#551AA9] text-[20px] items-center">Limited</span>
    </div>
    <div class="flex ">
...
<div class="w-[1380px] mx-auto">
    <div class="flex">
        ...
        <div class="ml-10">
            ...
            <div class="my-4">
                <span class="inline-block bg-[#142850] text-xl px-2 py-1 rounded-full text-white">2020</span>
                <span class="text-[#8695A4] text-xl ml-4">Dashboard</span>
            </div>
            <p class="text-[21px] hover:underline">Under the premise that toys are tools for the
    ...
    <div class="flex">
        ...
        <div class="ml-10">
            ...
            <div class="my-4">
                <span class="inline-block bg-[#142850] text-[20px] px-2 py-1 rounded-full text-white">2018</span>
                <span class="text-[#8695A4] text-xl ml-4">Illustration</span>
            </div>
            <p class="text-[21px] hover:underline">Under the premise that toys are tools for the
                imagination, the collection
                reflects the transition from childlike naïveté to grown-up refinement. Elevating childhood
