...
<body>
    <div class="w-[7%] logout hidden bg-white space-y-4" id="logout">
        <div class="flex items-center space-x-4">
            ...
            <li class="list-none">
                <form method="post" action="../site/index.php?act=signout"><input name="signout" value="Đăng xuất" type="submit" ></form></li>
        </div>
    </div>
        ...
        <div class="ad-l w-[15%] mx-10">
            ...
            <div class="bg-slate-50 h-[500px]">
                ...
                <div class="flex py-4 px-4 space-x-2 hover:shadow-lg hover:shadow-cyan-500/50">
                    ...
                    <a href="index.php?act=binhluan" class="hover:text-[#551AA9]">Bình Luận</a>
                </div>
                <div class="flex py-4 px-4 space-x-2 hover:shadow-lg hover:shadow-cyan-500/50">
                ...
                <div class="flex py-4 px-4 hover:shadow-lg hover:shadow-cyan-500/50">
                    ...
                    <a href="index.php?act=thongke" class="hover:text-[#551AA9]">Thống kê</a>
                </div>
            </div>
        </div>
        <div class="ad-r w-[80%] ">
