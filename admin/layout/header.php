...
<body>
    <div class="w-[7%] logout hidden bg-white space-y-4" id="logout">
        ...
        <div class="flex items-center space-x-4">
            ...
            <li class="list-none"><a href="">Đăng xuất</a></li>
        </div>
    </div>
        ...
        <div class="ad-l w-[15%] mx-10">
            ...
            <div class="bg-slate-50 h-[500px]">
                <div class="flex pb-4 pt-4 px-4 items-center space-x-2 hover:bg-cyan-300 hover:text-white">
                    ...
                    <a href="show-product.php" class="hover:text-[#551AA9]">Xem trang Web</a>
                </div>
                ...
                <div class="flex py-4 px-4 items-center space-x-2  hover:bg-cyan-300 hover:text-white">
                    ...
                    <a href="show-product.php" class="hover:text-[#551AA9]">Trang chủ</a>
                </div>
                ...
                <div class="flex py-4 px-4 space-x-2 hover:bg-cyan-300 hover:text-white">
                    ...
                    <a href="show-cate.php" class="hover:text-[#551AA9]">Bình Luận</a>
                </div>
                <div class="flex py-4 px-4 space-x-2 hover:bg-cyan-300 hover:text-white">
                    ...
                    <a href="show-cate.php" class="hover:text-[#551AA9]">Đơn Hàng</a>
                </div>
