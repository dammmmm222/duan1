            ...
            <div class="home mt-5 mr-8 bg-[#F4F6FA] h-auto rounded">
                <div class="admin   px-40 py-4 my-10 mx-8 rounded-md">
                    ...
                    <div class="ad-r">
                        ...
                        <form action="index.php?act=them_san_pham" method="post" enctype="multipart/form-data" class=""
                            id="update_hang_hoa">


                            <p class="text-[#551AA9] text-[20px] my-4" for="">Tên Sản Phẩm</p><input type="text"
                                name="product_name" placeholder="LV ...."
                            ...
                            <?php endif ?>
                            <p class="text-[#551AA9] text-[20px] my-4" for="">Giá</p><input type="text"
                                name="product_price" placeholder="999$ ...."
                                class="border w-full px-10 rounded-lg py-2 mt-2">
                            ...
                            <?php endif ?>
                            <p class="text-[#551AA9] text-[20px] my-4" for="">Giảm Giá</p><input type="text"
                                name="product_price_sale" placeholder="899$ ...."
                                class="border w-full px-10 rounded-lg py-2 mt-2">
                            ...
                            <br>
                            <textarea cols="30" rows="10" placeholder="Expensive ..." name="description"
                                class="border w-full rounded-lg px-10 py-2 h-48 mt-2"></textarea>
                            ...
                            <p class="text-[#551AA9] text-[20px] my-4" for="">Origin</p><input type="text" name="origin"
                                placeholder="899$ ...." class="border w-full px-10 rounded-lg py-2 mt-2">
