            ...
            <div class="home mt-5 mr-8 bg-[#F4F6FA] h-auto rounded px-10">
                <div class="ad-r px-40 py-10">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="">
                        ...
                        <p class="text-[#551AA9] text-[20px] my-4" for="">Cate_Name</p><input type="text"
                            name="cate_name" placeholder="Túi ...." class="px-10 py-2 rounded-md">
