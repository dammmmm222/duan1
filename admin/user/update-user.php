            ...
            <div class="home mt-5  px-40 py-10 mr-8 bg-[#F4F6FA] h-auto rounded">
                <h3 class="text-center text-3xl">SỬA NGƯỜI DÙNG</h3>
                    ...
                    <div class="ad-r">
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="">
                            ...
                            <p class="text-[#551AA9] text-[20px] my-4" for="">Tài khoản</p> <input type="text"
                                ...
                                class="px-10 py-2 rounded-md">
                            <?php if (isset($username_err)) : ?>
                            <span style="color:red" ;>
                                <?= $username_err ?>
                            </span>
                            <?php endif ?>
                            <p class="text-[#551AA9] text-[20px] my-4" for="">Mật khẩu</p><input type="text"
                                name="password" value="<?= $user['password'] ?>" placeholder="******"
                                class="px-10 py-2 rounded-md">
                            ...
                            <button type="submit" name="btn_luu"
                                class="bg-[#ff523b] my-10 py-2 px-8 hover:bg-[#BAAACE] hover:text-white rounded-lg">Update
                                User</button>
                        </form>
